...
// This component is the content which is visible when someone clicks on the share button
  ...
  return (
    <div className="sharecontent">
      <div className="sharecontent__header">
        ...
        <div>
          <span>
            <HelpOutlineIcon style={muiIconStyle} />
          </span>
          <span>
            <SettingsOutlinedIcon style={muiIconStyle} />
          </span>
        </div>
      </div>
