    ...
    <div className='sidebar' aria-expanded={toggleOpen}>
        <div className="sidebar__icons">
            <div className='sidebar__icons__icon'> 
                <a href="https://calendar.google.com/calendar/u/0/r" target='_blank' title='Calendar'>
            ...
            <div className='sidebar__icons__icon'>
                <a href="https://contacts.google.com/" target='_blank' title='Contacts'>
        ...
        <div className={`sidebar__toggle`} >
            ...
            <ArrowForwardIosIcon className={toggleOpen ? 'icon-close' : 'icon-open'}/>
            </button>
        </div>
    </div>
  )
